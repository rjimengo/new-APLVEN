...
import { indicadoresVCN, productosObjs } from 'src/config/ventasGlobalIDs';
...
export class ProductosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dimensionSel = this._ComunService.initDimension(this._ComunService.dimensionGlobal, 2); // 2 porque corresponde a Productos
