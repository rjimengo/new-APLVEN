...
import { indicadoresVCN, canales } from 'src/config/ventasGlobalIDs';
...
export class CanalesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dimensionSel = this._ComunService.initDimension(this._ComunService.dimensionGlobal, 3); // 3 porque corresponde a Canales
