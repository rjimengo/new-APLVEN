...
export class RankingComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dimensionSel = this._ComunService.initDimension(this._ComunService.dimensionGlobal, null);
    ...
    this.topBottomOpt = ['Top 50', 'Bottom 50'];
    //Inicializar TopBottom
    this._ComunService.topBottomGlobal = this.topBottomOpt[0];//Se inicializa a Top 50
